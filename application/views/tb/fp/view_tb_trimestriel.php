<div id="div_tb_ainserer">
	<?php
	   ...
	   if ($val_Annee1==0)
		...
		echo '<table id="visu_tb_trimestriel" class="table table-hover" border="1" width="100%">'."\n";//style="table-layout:fixed;" bgcolor="#FFFFFF"
			//if ($classe=='tb'){
				$col_span=20;
			...
			foreach($resultat->result_array() as $row){
				...
				elseif ($row['niveau']==5){
					...
					//}
						...
						echo '<td hidden>'.$row['sql_liste'].'</td>'; //'.$r["realisation_annee"].' 
						echo '<td>'.$tot.'</td>'; //'.$r["realisation_annee"].' 
						echo '<td id="td_'.$row['id'].'_trim1" alt="3"><a href="#td_'.$row['id'].'_trim1">'.$t1.'</a></td>'; 
						echo '<td id="td_'.$row['id'].'_trim2" alt="6"><a href="#td_'.$row['id'].'_trim2">'.$t2.'</a></td>'; 
						echo '<td id="td_'.$row['id'].'_trim3" alt="9"><a href="#td_'.$row['id'].'_trim3">'.$t3.'</a></td>';
						echo '<td id="td_'.$row['id'].'_trim4" alt="12"><a href="#td_'.$row['id'].'_trim4">'.$t4.'</a></td>';
