...
ZeroClipboard_TableTools.Client.prototype = {
	...
	setlocalhostName: function(newText) {
		// set the file name
		this.fileName = newText;
		if (this.ready) {
			this.movie.setlocalhostName(newText);
		}
	},
	...
	receiveEvent: function(eventName, args) {
		...
		switch (eventName) {
			case 'load':
				...
				this.movie.setlocalhostName( this.fileName );
...
TableTools.prototype = {
	...
	"_fnFlashConfig": function ( nButton, oConfig )
	{
		...
		if ( oConfig.sAction == "flash_save" )
		{
			...
			flash.setlocalhostName( oConfig.slocalhostName.replace('*', this.fnGetTitle(oConfig)) );
		}
